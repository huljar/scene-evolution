...
bool BooleanFactor::eval(RGBDScene* rgbdScene, const Scene& currentScene, const SceneObject& obj, const DatasetManager::LabelMap& labels) const {
    return mNegate != mChild->eval(rgbdScene, currentScene, obj, labels);
}
